        ...
        <div class="table-wrapper h-100 w-100">
            <div class="h-100 w-100" id="loadHere">
                <table id="myTable" class="table" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT tbl_events.id, tbl_accounts.id AS account_id, tbl_events.title, tbl_events.day, tbl_events.startTime, tbl_events.endTime, tbl_event_participants.status, tbl_event_participants.certificate_sent, tbl_event_participants.role
                            FROM tbl_events
                            ...
                            WHERE account_id = ? AND day < ? AND tbl_event_participants.role = 'Participant'
