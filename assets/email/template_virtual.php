  ...
  <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%;" class="background">
	...
	max-width: 500px;" class="wrapper">
          ...
          <tr>
			...
			padding-bottom: 20px;">
              ...
              <div style="display: none; visibility: hidden; overflow: hidden; opacity: 0; font-size: 1px; line-height: 1px; height: 0; max-height: 0; max-width: 0;
                ...
                design is&nbsp;a&nbsp;must for&nbsp;email campaigns. -->You are formally invited to {EVENT_TITLE}.
              </div>

              <!-- LOGO -->
              <!-- Image text color should be opposite to background color. Set your url, image src, alt and title. Alt text should fit the image size. Real image size should be x2. URL format: http://domain.com/?utm_source={{Campaign-Source}}&utm_medium=email&utm_content=logo&utm_campaign={{Campaign-Name}} -->
              <a target="_blank" style="text-decoration: none;" href="https://wmsu-cce.online/">
                <img border="0" vspace="0" hspace="0" src="https://i.ibb.co/q1cfw58/cce-logo.png" height="30" alt="Logo" title="Logo" style="
				color: #FFFFFF;
          ...
          <tr>
			...
			padding-top: 0px;" class="hero"><a target="_blank" style="text-decoration: none;" href="{EVENT_LINK}?id={EVENT_ID}"><img border="0" vspace="0" hspace="0" src="https://wmsu-cce.online/assets/attachments/events/{EVENT_IMG}" title="Hero Image" width="340" style="
			width: 87.5%;
			max-width: 340px;
          ...
          <tr>
			...
			font-family: sans-serif;" class="paragraph">
              Join us for an unforgettable gathering, filled with joy, connections, and memorable moments. Your presence will make it extraordinary!
            </td>
          </tr>
          ...
          <tr>
            <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			padding-top: 25px;
			padding-bottom: 5px;" class="button"><a href="{EVENT_LINK}?id={EVENT_ID}" target="_blank" style="text-decoration: underline;">
                <table border="0" cellpadding="0" cellspacing="0" align="center" style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;">
                  <tr>
					...
					color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;" href="{EVENT_LINK}?id={EVENT_ID}">
                        Join Now!
                      </a>
                    </td>
                  </tr>
          ...
          <tr>
			...
			font-family: sans-serif;" class="footer">
              ...
              This email was sent to you to share in the excitement of our upcoming event. Your presence adds value, and we look forward to creating memorable experiences together.
